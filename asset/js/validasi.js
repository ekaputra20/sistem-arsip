...
jQuery(function(){
    ...
    jQuery("#deskripsi").validate({
        expression: "if (VAL) return true; else return false;",
        message: "Tempat pelaksanaan tidak boleh kosong"
    });

    jQuery("#passs").validate({
        expression: "if (VAL.length > 5 && VAL) return true; else return false;",
        message: "Password minimal 5 karakter"
    });

    jQuery("#ConfirmPass").validate({
        expression: "if ((VAL == jQuery('#passs').val()) && VAL) return true; else return false;",
    ...
    jQuery("#lampiran").validate({
        expression: "if (VAL) return true; else return false;",
        message: "Lampiran tidak boleh kosong. Maksimal 1000 KB atau 1 MB tiap file"
    });
